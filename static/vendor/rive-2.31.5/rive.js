...
var RuntimeLoader = /** @class */ (function () {
    ...
    RuntimeLoader.loadRuntime = function () {
        _rive_advanced_mjs__WEBPACK_IMPORTED_MODULE_0__["default"]({
            ...
            // yopa.page intentionally fails closed to its static water frame.
            // Do not retry a third-party CDN when the self-hosted WASM fails.
            var errorMessage = [
                "Could not load self-hosted Rive WASM from ".concat(RuntimeLoader.wasmURL, "."),
                "The Article Atlas renderer will keep using its static fallback.",
                "\nError details:",
